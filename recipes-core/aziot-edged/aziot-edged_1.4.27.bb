...
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=aziot-identity-client-async;destsuffix=identity/aziot-identity-client-async;subpath=identity/aziot-identity-client-async"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=aziot-identity-common;destsuffix=identity/aziot-identity-common;subpath=identity/aziot-identity-common"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=aziot-identity-common-http;destsuffix=identity/aziot-identity-common-http;subpath=identity/aziot-identity-common-http"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=http-common;destsuffix=http-common;subpath=http-common"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=logger;destsuffix=logger;subpath=logger"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=aziotctl-common;destsuffix=aziotctl/aziotctl-common;subpath=aziotctl/aziotctl-common"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=aziot-certd-config;destsuffix=cert/aziot-certd-config;subpath=cert/aziot-certd-config"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=cert-renewal;destsuffix=cert/cert-renewal;subpath=cert/cert-renewal"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=config-common;destsuffix=config-common;subpath=config-common"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=test-common;destsuffix=test-common;subpath=test-common"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=aziot-cert-client-async;destsuffix=cert/aziot-cert-client-async;subpath=cert/aziot-cert-client-async"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=aziot-cert-common-http;destsuffix=cert/aziot-cert-common-http;subpath=cert/aziot-cert-common-http"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=aziot-key-client;destsuffix=key/aziot-key-client;subpath=key/aziot-key-client"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=aziot-keyd-config;destsuffix=key/aziot-keyd-config;subpath=key/aziot-keyd-config"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=aziot-keys-common;destsuffix=key/aziot-keys-common;subpath=key/aziot-keys-common"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=aziot-tpmd-config;destsuffix=tpm/aziot-tpmd-config;subpath=tpm/aziot-tpmd-config"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=aziot-identityd-config;destsuffix=identity/aziot-identityd-config;subpath=identity/aziot-identityd-config"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=aziot-key-client-async;destsuffix=key/aziot-key-client-async;subpath=key/aziot-key-client-async"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=aziot-key-common;destsuffix=key/aziot-key-common;subpath=key/aziot-key-common"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=aziot-key-common-http;destsuffix=key/aziot-key-common-http;subpath=key/aziot-key-common-http"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=aziot-key-openssl-engine;destsuffix=key/aziot-key-openssl-engine;subpath=key/aziot-key-openssl-engine"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=openssl-sys2;destsuffix=openssl-sys2;subpath=openssl-sys2"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=openssl2;destsuffix=openssl2;subpath=openssl2"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=openssl-build;destsuffix=openssl-build;subpath=openssl-build"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=pkcs11;destsuffix=pkcs11/pkcs11;subpath=pkcs11/pkcs11"
SRC_URI += " git://github.com/Azure/iot-identity-service.git;protocol=https;branch=release/1.4;name=pkcs11-sys;destsuffix=pkcs11/pkcs11-sys;subpath=pkcs11/pkcs11-sys"

SRCREV = "7b1d45bcd091c082ea51193d920a97d680f8dc9b"
SRCREV_aziot-identity-client-async = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_aziot-identity-common = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_aziot-identity-common-http = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_http-common = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_logger = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_aziotctl-common = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_aziot-certd-config = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_cert-renewal = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_config-common = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_test-common = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_aziot-cert-client-async = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_aziot-cert-common-http = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_aziot-key-client = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_aziot-key-client-async  = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_aziot-keyd-config = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_aziot-keys-common = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_aziot-tpmd-config = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_aziot-identityd-config = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_aziot-key-common = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_aziot-key-common-http = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_aziot-key-openssl-engine = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_openssl-sys2 = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_openssl2 = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_openssl-build = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_pkcs11 = "91e058880c4eb27756a15b74b52a031e0604207a"
SRCREV_pkcs11-sys = "91e058880c4eb27756a15b74b52a031e0604207a"
...
SRC_URI[chrono-humanize-0.2.2.sha256sum] = "32dce1ea1988dbdf9f9815ff11425828523bd2a134ec0805d2ac8af26ee6096e"
